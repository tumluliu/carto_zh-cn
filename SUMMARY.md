...
* [基础用法](src/basics/basics.md)
   ...
   * [配置线样式](src/basics/styling_lines.md)
   * [配置面样式](src/basics/styling_polygons.md)
   * [配置标注样式](src/basics/styling_labels.md)
...
* [高级技巧](src/advanced/advanced.md)
   * [高级地图设计](src/advanced/map-design.md)
   * [色彩使用技巧](src/advanced/colors.md)
